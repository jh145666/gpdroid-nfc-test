...
public class GPConnection {
        ...
        /** Selected security domain AID, null means auto-detect */
        private AID mSelectedSdAID = null;
        ...
        /**
         * Sets the security domain AID to be used when opening a connection.
         * Pass null to use auto-detect mode (try all known SD AIDs).
         * @param sdAID the security domain AID, or null for auto-detect
         */
        public void setSelectedSdAID(AID sdAID) {
                mSelectedSdAID = sdAID;
        }

        /**
         * Gets the currently selected security domain AID.
         * @return the selected SD AID, or null if auto-detect mode
         */
        public AID getSelectedSdAID() {
                return mSelectedSdAID;
        }
        ...
        private void initializeKeys(CardChannel channel, GPKeyset keyset) {
                if (mSelectedSdAID != null) {
                        mGPService = new GlobalPlatformService(mSelectedSdAID, channel);
                } else {
        ...
        private void open() throws GPSecurityDomainSelectionException, CardException {
                ...
                mGPService.open(mSelectedSdAID);
        }
